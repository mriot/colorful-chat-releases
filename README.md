...
[![latest release downloads](https://img.shields.io/github/downloads/mriot/colorful-chat-releases/latest/colorful_chat.dll?displayAssetName=false&label=latest%20release%20downloads&color=blue)](https://github.com/mriot/colorful-chat-releases/releases/latest)
[![total downloads](https://img.shields.io/github/downloads/mriot/colorful-chat-releases/total?color=red&label=total%20downloads)](https://github.com/mriot/colorful-chat-releases/releases)
...
- A high contrast option is available to improve readability even further.
